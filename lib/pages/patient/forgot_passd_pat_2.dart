...
class ForgotPasswdPatient2 extends StatefulWidget {
  const ForgotPasswdPatient2({super.key});

  @override
  _ForgotPasswdPatient2State createState() => _ForgotPasswdPatient2State();
}

class _ForgotPasswdPatient2State extends State<ForgotPasswdPatient2> {
