...
class GainingConf extends StatefulWidget {
  const GainingConf({super.key});

  @override
  State<GainingConf> createState() => _GainingConfState();
}

class _GainingConfState extends State<GainingConf> {
  @override
