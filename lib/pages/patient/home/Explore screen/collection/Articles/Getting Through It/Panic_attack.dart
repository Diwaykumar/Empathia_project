...
class PanicAttack extends StatefulWidget {
  const PanicAttack({super.key});

  @override
  State<PanicAttack> createState() => _PanicAttackState();
}

class _PanicAttackState extends State<PanicAttack> {
  @override
